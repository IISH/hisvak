...
public class VelocityResourceResponseWriter implements QueryResponseWriter {
...
//  private static final Logger log = LoggerFactory.getLogger(VelocityResponseWriter.class);
    ...
    public void write(Writer writer, SolrQueryRequest request, SolrQueryResponse response) throws IOException {
        ...
        SolrResourceLoader resourceLoader = request.getCore().getSolrConfig().getResourceLoader();
        context.put("resource", new SolrVelocityResourceTool(resourceLoader.getClassLoader(), request.getParams().get("lang")));
